...
<body>
        ...
        <form runat="server">
            <table style="text-align: center; width: 20%; margin-left: auto; margin-right: auto;" border="0">
                <tbody>
                    <tr>
                        <td>
                            <asp:TextBox ID="nnid" placeholder="Nintendo Network ID" class="form-control empty floating-label"
                                onkeyup="checkPass(); return false;" runat="server"> </asp:TextBox><br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:TextBox placeholder="KarterShop Password" ID="pass1"
                    ...
                    <tr>
                        <td>
                            <asp:TextBox placeholder="Confirm Password" ID="pass2"
                                class="form-control empty floating-label" onkeyup="checkPass(); return false;"
                                TextMode="password" runat="server"></asp:TextBox>
                            <br>
                        </td>
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <asp:Button Text="Please enter your NNID" class="btn btn-danger" Style="left: 0px;" ID="confirmMessage" runat="server" OnClick="doRegister" disabled></asp:Button>
                            <br>
                        </td>
                    </tr>
                </tbody>
    ...
    <div style="text-align: center; height: 229px;">
        <!-- Your site ends -->
    </div>
